...
public class FiftyYearsWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FiftyYearsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/50YearsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/50YearsWLAIW/InitOutcome.xml").getDocumentElement();
